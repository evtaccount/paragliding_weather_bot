...
# Отношение порыв/ветер бессмысленно на слабом ветре: 0,3 → 0,5 м/с это «фактор
# 1,67» и ложное вето. Ниже этого ветра работает только абсолютная дельта.
# Документ такой оговорки не даёт — она добавлена здесь.
GUST_FACTOR_MIN_WIND_MS = 2.0
