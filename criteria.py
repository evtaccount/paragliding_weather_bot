...
# «идеального» диапазона у земли. При более слабом ветре отношение перестаёт
# расти до бесконечности, а порывистость оценивает абсолютный отрыв
...
# данных, где иначе половина дневных часов получала ложное вето.
GUST_FACTOR_REF_WIND_MS = 4.2
